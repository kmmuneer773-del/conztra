...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" className="group flex items-center space-x-3">
          ...
          <div className="flex flex-col">
            <span className="font-heading text-xl font-black tracking-widest text-white leading-none">
              CONZTRA
            </span>
            <span className="mt-1 text-[9px] font-bold uppercase tracking-wider text-secondary">
      ...
      {open && (
        <div className="flex flex-col gap-4 border-t border-white/10 bg-navy-950/95 px-6 py-4 backdrop-blur-md lg:hidden">
          {links.map((link) => (
            <Link
              key={link.href}
              href={link.href}
